      ...
      <Card className="w-full max-w-3xl border-gray-200 shadow-sm py-0">
        <CardContent className="space-y-5 pt-6 pb-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <Field data-invalid={!state?.success && !!state?.errors?.subject}>
              <FieldLabel htmlFor="subject-trigger" className="font-medium">
                Subject *
              </FieldLabel>
              <Combobox
            ...
            <Field data-invalid={!!state?.errors?.category}>
              <FieldLabel htmlFor="category" className="font-medium">
                Category *
              </FieldLabel>
          ...
          <Field data-invalid={!!state?.errors?.title}>
            <FieldLabel htmlFor="title" className="font-medium">
              Title *
            </FieldLabel>
            <Input
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <Field data-invalid={!!state?.errors?.academicYear}>
              <FieldLabel htmlFor="academic-year" className="font-medium">
                Academic Year
              </FieldLabel>
              <Select defaultValue="2024/2025" name="academic-year">
                <SelectTrigger
                  id="academic-year"
                  aria-invalid={!!state?.errors?.academicYear}
                  className="text-neutral-950 w-full"
                >
            ...
            <Field data-invalid={!!state?.errors?.meetingNo}>
              <Label htmlFor="meeting-no" className=" font-medium">
                Meeting No.
              </Label>
              <Input
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <Field data-invalid={!!state?.errors?.materialType}>
              <FieldLabel htmlFor="material-type" className="font-medium">
                Material Type
              </FieldLabel>
              <Select name="material-type">
                <SelectTrigger
                  id="material-type"
                  aria-invalid={!!state?.errors?.materialType}
          ...
          <Field data-invalid={!!state?.errors?.externalUrl}>
            <FieldLabel htmlFor="external-url" className="font-medium">
              External URL *
            </FieldLabel>
            <Input
